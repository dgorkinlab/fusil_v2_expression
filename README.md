...
**FUSIL gene categorizations from this paper** (store in input_data/FUSIL/)

**GENCODE gene annotations** (store in input_data/GENCODE/)
...
**Gene expression data from GTEx** (store in input_data/GTEx/)
...
**Gene expression data from Cardoso-Moreira, et al. Nature. 2019. PMID:31243369** (store in input_data/Cardoso-Moreira/)
